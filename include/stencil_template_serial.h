...
/*
* Inject energy in the plate
* the energy is injected in the sources
* the sources are randomly distributed on the plate
* and are defined by a pair of coordinates
*
                            ...
                            double *time_spent)
{
    ...
    // If the N of source is low, we can use a simple loop
    // otherwise we can parallelize the injection
